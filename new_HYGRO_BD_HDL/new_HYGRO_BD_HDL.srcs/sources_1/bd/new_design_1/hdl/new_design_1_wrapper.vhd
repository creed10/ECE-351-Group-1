...
--Command     : generate_target new_design_1_wrapper.bd
--Design      : new_design_1_wrapper
...
entity new_design_1_wrapper is
  port (
...
end new_design_1_wrapper;

architecture STRUCTURE of new_design_1_wrapper is
  component new_design_1 is
  port (
    sys_clock : in STD_LOGIC;
    usb_uart_rxd : in STD_LOGIC;
    usb_uart_txd : out STD_LOGIC;
...
new_design_1_i: component new_design_1
     port map (
