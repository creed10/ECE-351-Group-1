...
HD_PWD='C:/Users/Ryan/Desktop/Spring 2019/ECE351/FinalProject/new_HYGRO_BD_HDL/new_HYGRO_BD_HDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log new_design_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source new_design_1_wrapper.tcl
