...
HD_PWD='C:/Users/Ryan/Desktop/Spring 2019/ECE351/FinalProject/new_HYGRO_BD_HDL/new_HYGRO_BD_HDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log new_design_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source new_design_1_wrapper.tcl -notrace
