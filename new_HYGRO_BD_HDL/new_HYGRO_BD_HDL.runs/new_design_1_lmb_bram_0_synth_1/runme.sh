...
HD_PWD='C:/Users/Ryan/Desktop/Spring 2019/ECE351/FinalProject/new_HYGRO_BD_HDL/new_HYGRO_BD_HDL.runs/new_design_1_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log new_design_1_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source new_design_1_lmb_bram_0.tcl
