...
HD_PWD='C:/Users/Ryan/Desktop/Spring 2019/ECE351/newBlockDesign_WithPWMOutput/newBlockDesign_WithPWMOutput.runs/design_5_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_5_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_5_lmb_bram_0.tcl
