...
--Date        : Sat Apr 20 19:44:24 2019
--Host        : Ryan-pc running 64-bit major release  (build 9200)
--Command     : generate_target design_3_new_wrapper.bd
--Design      : design_3_new_wrapper
...
entity design_3_new_wrapper is
  port (
...
end design_3_new_wrapper;

architecture STRUCTURE of design_3_new_wrapper is
  component design_3_new is
  port (
    sys_clock : in STD_LOGIC;
...
begin
design_3_new_i: component design_3_new
     port map (
